...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fortawesome_vue_fontawesome__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__fortawesome_fontawesome_free_solid__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__view_App_vue__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__plugins_event_bus__ = __webpack_require__(85);
...
window.Request = __WEBPACK_IMPORTED_MODULE_4__services_request__["a" /* default */];

__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.post['Content-Type'] = 'multipart/form-data';

__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.baseURL = 'http://sistem.gasapplp.com/';
...
var update = __webpack_require__(6)("4827b68d", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("60c2610d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    Request.getCostumers().then(function (res) {
      _this.costumers = res.data;
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm._l(_vm.costumers, function(costumer) {
            return _c("tr", { attrs: { slot: "tbody" }, slot: "tbody" }, [
              _c("td", [_vm._v(_vm._s(costumer.nombre))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(costumer.correo))]),
              _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    AddUser: function AddUser() {
      Request.addCostumer(this.user).then(function (res) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("5d7e4414", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
          ...
          [
            ...
            _c("div", { staticClass: "group" }, [
              ...
              _c("input", {
                ...
                attrs: { type: "text", id: "user", placeholder: "Usuario" },
            ...
            _vm._v(" "),
            _c("div", { staticClass: "group" }, [
              _c("label", { attrs: { for: "password_confirmate" } }, [
            ...
            _c("div", { staticClass: "group" }, [
              ...
              _c("input", {
                ...
                attrs: { type: "text", id: "phone", placeholder: "Teléfono" },
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.user, "curp", $event.target.value)
                  }
                }
              })
            ]),
...
Request.getCostumers = function () {
    return new Promise(function (resolve, reject) {
        Axios.get(Api.AppCostumers.getCostumers).then(function (res) {
            resolve(res.data);
        }).catch(function (error) {
            reject(error.data);
        });
...
Request.addCostumer = function (user) {
    return new Promise(function (resolve, reject) {
        Axios.post(Api.AppCostumers.addCostumer, user).then(function (res) {
            resolve(res);
        }).catch(function (error) {
            reject(error);
        });
